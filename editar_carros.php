                    ...
                    <div id="menu">
                        ...
                        <div id="wrapperlogin">
                            <form enctype="multipart/form-data" method="POST" action="salvaEditaCarro.php">
                                ...
                                <input type="checkbox" id="textocadastra" name="direcaoAutomovel" <?php if($direcaoAutomovel) {echo "checked = 'checked'";} ?> />
                                <br>

                                <label id="textocadastracheck">Ar Condicionado: </label>
                                <input type="checkbox" id="textocadastra" name="ar_condicionadoAutomovel" <?php if($ar_condicionadoAutomovel) {echo "checked = 'checked'";} ?> />
                                <br>

                                <label id="textocadastracheck">Manutenção: </label>
                                <input type="checkbox" id="textocadastra" name="manutencaoAutomovel" <?php if($manutencaoAutomovel) {echo "checked = 'checked'";} ?> />
                                <br>

                                <label id="textocadastracheck">Status: </label>
                                <input type="checkbox" id="textocadastra" name="statusAutomovel" <?php if($statusAutomovel) {echo "checked = 'checked'";} ?> />
                                <br>
                                ...
                                <button type="submit" id="botaoCancelar" class="button" action="index.php">
                                    Cancelar
                                </button>
                                </div>
                            </form>
