            ...
            <div id="header" class="container">
                <div id="logo">
                    ...
                    <div id="menu">
                        ...
                        <li><a href="interface_suv.php" accesskey="2" title="">Utilitários</a></li>
                        <li class="current_page_item"><a href="interface_utilitarios.php" accesskey="3" title="">SUV</a></li>
                    ...
                    #SQL para listagem
                    $query = "SELECT * FROM automovel WHERE tipo = 'Utilitarios'";
